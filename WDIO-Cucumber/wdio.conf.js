const stepsFolder = './folders/stepDefs';
const fs = require('fs');
...
exports.config = {
    ...
    screenshotPath: './folders/screenShots/',
    //
    ...
    reporterOptions: {
        htmlReporter: {
            jsonFolder: './folders/reports/json',
            reportFolder: `./folders/reports`,
            removeFolders: true, //To start run as a clean test
            openReportInBrowser: true,
            disableLog:true,
            pageTitle: 'Barclaycard Smartpay Automation Report',
            reportName: 'Barclaycard Smartpay Automation Report',
            pageFooter: '<div align="center"><p>Barclaycard</p></div>',
